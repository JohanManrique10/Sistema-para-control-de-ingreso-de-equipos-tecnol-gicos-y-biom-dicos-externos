...
def log_empresa_audit(db, *, empresa_id: int, action: str, detail: dict | None = None, actor_user_id: int | None = None):
    from models import EmpresaAudit
    entry = EmpresaAudit(
        ...
        try:
            ...
            try:
                log_empresa_audit(
                    ...
                    detail={"created": {"id": emp.id, "identificacion": emp.identificacion, "nombre": emp.nombre}},
...
def empresas_edit(empresa_id: int):
    ...
    try:
        ...
        if form.validate_on_submit():
            ...
            old_ident = emp.identificacion
            old_nombre = emp.nombre
            ...
            changes = {}
            if old_ident != emp.identificacion:
                changes['identificacion'] = {'old': old_ident, 'new': emp.identificacion}
            if old_nombre != emp.nombre:
                changes['nombre'] = {'old': old_nombre, 'new': emp.nombre}
