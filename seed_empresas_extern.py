...
engine = create_engine(
    DATABASE_URL,
    pool_pre_ping=True,
    connect_args={"sslmode": "require"} if DATABASE_URL.startswith("postgresql") else {},  # igual que en app.py
)
...
EMPRESAS_SEED = [
    ...
    {"identificacion": "902777888-4", "nombre": "Tecno Movil"},
    {"identificacion": "903999000-5", "nombre": "Tecno Poli"},
    {"identificacion": "904111222-6", "nombre": "Ingeniería Electrónica S.A."},
    {"identificacion": "905333444-7", "nombre": "Sistemas Médicos Avanzados"},
]
