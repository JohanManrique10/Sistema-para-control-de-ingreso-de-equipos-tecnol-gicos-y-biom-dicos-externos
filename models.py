...
class EmpresaAudit(Base):
    ...
    actor = relationship("User", backref="empresa_audits", foreign_keys=[actor_user_id])
...
class Equipo(Base):
    ...
    estado: Mapped[str] = mapped_column(
        SAEnum("pendiente", "en_revision", "aprobado", "devuelto"),
        nullable=False,
        default="pendiente",
...
class Notification(Base):
    ...
    level: Mapped[str] = mapped_column(
        SAEnum("info", "success", "warning", "danger"),
        nullable=False,
        server_default="info"
    )
